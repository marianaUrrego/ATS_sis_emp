...
const areachartOptions = computed(() => {
    return {
        ...
        colors: ['#ff6692', 'rgba(var(--v-theme-secondary))', 'rgba(var(--v-theme-primary))'],
        plotOptions: {},
        dataLabels: {
            enabled: false
        },
        ...
        fill: {
            type: 'solid',
            colors: ['rgba(var(--v-theme-primary),0.03)'],
            opacity: 0.05
        },
        xaxis: {
            axisBorder: {
        ...
        markers: {
            strokeColor: ['#ff6692', 'rgba(var(--v-theme-secondary))', 'rgba(var(--v-theme-primary))'],
            strokeWidth: 2
        },
        tooltip: {
            theme: 'dark'
            ...
            <div class="d-md-flex justify-space-between mb-mb-0 mb-3">
                ...
                <div class="d-flex align-center gap-4">
                    <div class="d-flex align-center gap-2">
                        ...
                        <span class="textSecondary">2025</span>
                    </div>
                    <div class="d-flex align-center gap-2">
