    ...
    series: [
        {
            data: [
                {
                    x: 'Sun',
                    y: [new Date('2025-02-27').getTime(), new Date('2025-03-04').getTime()],
                    fillColor: 'rgba(var(--v-theme-primary))'
                },
                {
                    x: 'Mon',
                    y: [new Date('2025-03-04').getTime(), new Date('2025-03-10').getTime()],
                    fillColor: 'rgba(var(--v-theme-grey200),0.8)'
                },
                {
                    x: 'Tue',
                    y: [new Date('2025-03-01').getTime(), new Date('2025-03-06').getTime()],
