...
<template>
    <v-row v-if="isLoadingOferta" class="text-center">
        <v-col cols="12">
    ...
    <template v-else-if="errorOferta">
        <v-row class="text-center text-error">
            <v-col cols="12">
                <p>{{ errorOferta }}</p>
                <v-btn color="primary" class="mt-3" @click="cargarOferta">Reintentar</v-btn>
            </v-col>
        </v-row>
    </template>
